...
coder_z = coder.typeof(z,[1 200],[0 1]);%200 interfaces max
...
codegen -config mexcfg -o get_CSEM1D_FD_FHT_aniso_hed_mex -report get_CSEM1D_FD_FHT_aniso_hed.m ...
    -args {coder_f,coder_r,coder_zRx,zTx,coder_z,coder_sig,filterName,lUseLaggedConv}
