...
MAKEFILE = get_CSEM1D_FD_FHT_aniso_hed_ved_mex.mk

include get_CSEM1D_FD_FHT_aniso_hed_ved_mex.mki


SRC_FILES =  \
	get_CSEM1D_FD_FHT_aniso_hed_ved_mexutil.c \
	get_CSEM1D_FD_FHT_aniso_hed_ved_data.c \
	...
	get_CSEM1D_FD_FHT_aniso_hed_ved_emxutil.c \
	get_CSEM1D_FD_FHT_aniso_hed_ved_mex.c

MEX_FILE_NAME_WO_EXT = get_CSEM1D_FD_FHT_aniso_hed_ved_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/get_CSEM1D_FD_FHT_aniso_hed_ved"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/get_CSEM1D_FD_FHT_aniso_hed_ved/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/get_CSEM1D_FD_FHT_aniso_hed_ved/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/get_CSEM1D_FD_FHT_aniso_hed_ved/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
