 ...
 *
 * Code generation for function 'get_CSEM1D_FD_FHT_aniso_hed_api'
 *
...
static emlrtRTEInfo ib_emlrtRTEI = { 1, 1, "get_CSEM1D_FD_FHT_aniso_hed_api", ""
};

/* Function Declarations */
static void b_info_helper(ResolvedFunctionInfo info[197]);
static void c_emlrt_marshallIn(const mxArray *freqs, const char_T *identifier,
  emxArray_real_T *y);
static const mxArray *c_emlrt_marshallOut(ResolvedFunctionInfo u[197]);
static void c_info_helper(ResolvedFunctionInfo info[197]);
static void d_emlrt_marshallIn(const mxArray *u, const emlrtMsgIdentifier
  *parentId, emxArray_real_T *y);
static void d_info_helper(ResolvedFunctionInfo info[197]);
...
static void i_emlrt_marshallIn(const mxArray *sig, const char_T *identifier,
  emxArray_real_T *y);
static void info_helper(ResolvedFunctionInfo info[197]);
...
static void b_info_helper(ResolvedFunctionInfo info[197])
{
  ...
  info[65].context =
    "[E]/Users/anray/Documents/MATLAB/PT/RJ_MCMC/mex/get_CSEM1D_FD_FHT_aniso_hed.m";
  ...
  info[108].context =
    "[E]/Users/anray/Documents/MATLAB/PT/RJ_MCMC/mex/get_CSEM1D_FD_FHT_aniso_hed.m!getCSEM1DKernels_aniso_hed";
...
static const mxArray *c_emlrt_marshallOut(ResolvedFunctionInfo u[197])
{
  ...
  y = NULL;
  iv48[0] = 197;
  emlrtAssign(&y, mxCreateStructArray(1, iv48, 0, NULL));
  for (i15 = 0; i15 < 197; i15++) {
    r21 = &u[i15];
    b_u = r21->context;
    b_y = NULL;
...
static void c_info_helper(ResolvedFunctionInfo info[197])
{
  ...
  info[165].context =
    "[E]/Users/anray/Documents/MATLAB/PT/RJ_MCMC/mex/get_CSEM1D_FD_FHT_aniso_hed.m!stacks";
  info[165].name = "diff";
  ...
  info[185].context =
    "[E]/Users/anray/Documents/MATLAB/PT/RJ_MCMC/mex/get_CSEM1D_FD_FHT_aniso_hed.m!get_curly_R";
  ...
  info[188].name = "mrdivide";
  info[188].dominantType = "double";
  info[188].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p";
  info[188].fileTimeLo = 1357983948U;
  info[188].fileTimeHi = 0U;
  info[188].mFileTimeLo = 1319762366U;
  info[188].mFileTimeHi = 0U;
  info[189].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_flint_colon";
  info[189].name = "floor";
  info[189].dominantType = "double";
  info[189].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  info[189].fileTimeLo = 1343862780U;
  info[189].fileTimeHi = 0U;
  info[189].mFileTimeLo = 0U;
  info[189].mFileTimeHi = 0U;
  info[190].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_flint_colon";
  info[190].name = "eml_index_class";
  info[190].dominantType = "";
  info[190].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  info[190].fileTimeLo = 1323202978U;
  info[190].fileTimeHi = 0U;
  info[190].mFileTimeLo = 0U;
  info[190].mFileTimeHi = 0U;
  info[191].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_flint_colon";
  info[191].name = "intmax";
  info[191].dominantType = "char";
  info[191].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  info[191].fileTimeLo = 1311287716U;
...
static void d_info_helper(ResolvedFunctionInfo info[197])
{
  ...
  info[192].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/log10.m";
  info[192].fileTimeLo = 1343862782U;
  info[192].fileTimeHi = 0U;
  info[192].mFileTimeLo = 0U;
  info[192].mFileTimeHi = 0U;
  info[193].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/log10.m";
  info[193].name = "eml_error";
  info[193].dominantType = "char";
  info[193].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  info[193].fileTimeLo = 1343862758U;
  info[193].fileTimeHi = 0U;
  info[193].mFileTimeLo = 0U;
  info[193].mFileTimeHi = 0U;
  info[194].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/log10.m";
  info[194].name = "eml_scalar_log10";
  info[194].dominantType = "double";
  info[194].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_log10.m";
  info[194].fileTimeLo = 1286851128U;
  info[194].fileTimeHi = 0U;
  info[194].mFileTimeLo = 0U;
  info[194].mFileTimeHi = 0U;
  info[195].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_log10.m";
  info[195].name = "realmax";
  info[195].dominantType = "char";
  info[195].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmax.m";
  info[195].fileTimeLo = 1307683642U;
  ...
  info[196].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p";
  info[196].fileTimeLo = 1357983948U;
  info[196].fileTimeHi = 0U;
  info[196].mFileTimeLo = 1319762366U;
...
void get_CSEM1D_FD_FHT_aniso_hed_api(const mxArray * const prhs[8], const
  mxArray *plhs[6])
{
  ...
  emxInit_real_T(&freqs, 2, &ib_emlrtRTEI, TRUE);
  emxInit_real_T(&rRx, 2, &ib_emlrtRTEI, TRUE);
  emxInit_real_T(&zRx, 2, &ib_emlrtRTEI, TRUE);
  emxInit_real_T(&z, 2, &ib_emlrtRTEI, TRUE);
  emxInit_real_T(&sig, 2, &ib_emlrtRTEI, TRUE);
  emxInit_creal_T(&Er, 2, &ib_emlrtRTEI, TRUE);
  emxInit_creal_T(&Eb, 2, &ib_emlrtRTEI, TRUE);
  emxInit_creal_T(&Hr, 2, &ib_emlrtRTEI, TRUE);
  emxInit_creal_T(&Hb, 2, &ib_emlrtRTEI, TRUE);
  emxInit_creal_T(&Ez, 2, &ib_emlrtRTEI, TRUE);
  emxInit_creal_T(&Hz, 2, &ib_emlrtRTEI, TRUE);
  ...
  get_CSEM1D_FD_FHT_aniso_hed(freqs, rRx, zRx, zTx, z, sig, filterName,
    lUseLaggedConv, Er, Eb, Hr, Hb, Ez, Hz);
...
/* End of code generation (get_CSEM1D_FD_FHT_aniso_hed_api.c) */
