...
static emlrtRSInfo uc_emlrtRSI = { 13, "rdivide",
             ...
             emxArray_creal_T *z)
{
  ...
  real_T b_y[2];
  const mxArray *c_y;
  static const int32_T iv46[2] = { 1, 15 };
  ...
  if (isequal(b_x, b_y)) {
    ...
    c_y = NULL;
    m3 = mxCreateCharArray(2, iv46);
    for (i = 0; i < 15; i++) {
      cv18[i] = cv19[i];
    }

    emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 15, m3, cv18);
    emlrtAssign(&c_y, m3);
