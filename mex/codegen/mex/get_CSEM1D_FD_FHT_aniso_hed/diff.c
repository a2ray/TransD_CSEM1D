...
static emlrtRSInfo nb_emlrtRSI = { 51, "eml_int_forloop_overflow_check",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m"
};

static emlrtRSInfo jd_emlrtRSI = { 44, "diff",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/datafun/diff.m" };

static emlrtRSInfo nd_emlrtRSI = { 98, "diff",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/datafun/diff.m" };

static emlrtRSInfo od_emlrtRSI = { 100, "diff",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/datafun/diff.m" };
...
static emlrtRTEInfo eb_emlrtRTEI = { 1, 14, "diff",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/datafun/diff.m" };

static emlrtRTEInfo fb_emlrtRTEI = { 70, 1, "diff",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/datafun/diff.m" };

static emlrtRTEInfo gb_emlrtRTEI = { 71, 1, "diff",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/datafun/diff.m" };
...
{
  const mxArray *y;
  static const int32_T iv35[2] = { 1, 34 };

  const mxArray *m1;
  char_T cv11[34];
  int32_T i;
  static const char_T cv12[34] = { 'C', 'o', 'd', 'e', 'r', ':', 't', 'o', 'o',
    'l', 'b', 'o', 'x', ':', 'i', 'n', 't', '_', 'f', 'o', 'r', 'l', 'o', 'o',
    'p', '_', 'o', 'v', 'e', 'r', 'f', 'l', 'o', 'w' };

  const mxArray *b_y;
  static const int32_T iv36[2] = { 1, 23 };

  char_T cv13[23];
  static const char_T cv14[23] = { 'c', 'o', 'd', 'e', 'r', '.', 'i', 'n', 't',
  ...
  if (!overflow) {
    ...
    y = NULL;
    m1 = mxCreateCharArray(2, iv35);
    for (i = 0; i < 34; i++) {
      cv11[i] = cv12[i];
    }

    emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 34, m1, cv11);
    emlrtAssign(&y, m1);
    b_y = NULL;
    m1 = mxCreateCharArray(2, iv36);
    for (i = 0; i < 23; i++) {
      cv13[i] = cv14[i];
    }

    emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 23, m1, cv13);
    emlrtAssign(&b_y, m1);
...
void diff(const emxArray_real_T *x, emxArray_real_T *y)
{
  ...
  const mxArray *m5;
  char_T cv20[36];
  static const char_T cv21[36] = { 'C', 'o', 'd', 'e', 'r', ':', 't', 'o', 'o',
  ...
  if (x->size[1] == 0) {
    ...
    if (orderForDim < 1) {
      ...
      if (overflow) {
        ...
        b_y = NULL;
        m5 = mxCreateCharArray(2, iv47);
        for (orderForDim = 0; orderForDim < 36; orderForDim++) {
          cv20[orderForDim] = cv21[orderForDim];
        }

        emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 36, m5, cv20);
        emlrtAssign(&b_y, m5);
        error(b_message(b_y, &v_emlrtMCI), &w_emlrtMCI);
        emlrtPopRtStackR2012b(&jd_emlrtRSI, emlrtRootTLSGlobal);
      }

      b_emxInit_real_T(&work, 1, &fb_emlrtRTEI, TRUE);
      emxInit_real_T(&b_y1, 2, &gb_emlrtRTEI, TRUE);
